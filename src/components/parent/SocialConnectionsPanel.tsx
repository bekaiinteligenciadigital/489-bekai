...
import { RefreshCw, Link2, AlertTriangle, CheckCircle2, Clock3, PlugZap, Unplug } from 'lucide-react'
...
interface Props {
  ...
  onStartOAuth: (connection: SocialConnection) => Promise<void> | void
  onConnectManual: (connection: SocialConnection) => Promise<void> | void
  onDisconnect: (connection: SocialConnection) => Promise<void> | void
  syncing?: boolean
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <CardDescription>
              Base operacional do monitoramento: conexão, credencial, sincronização e trilha de status por plataforma.
            </CardDescription>
          </div>
          <Button
            size="sm"
                ...
                >
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="gap-2"
                      onClick={() => onConnectManual(connection)}
                      disabled={busy}
                    >
